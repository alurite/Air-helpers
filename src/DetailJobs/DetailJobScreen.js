...
const bidders = ['Yanga Ntondini', 'William Hunt', 'Jack Spearse'];
        ...
        <ScrollView>
          ...
          <View style={{flexDirection: 'column', backgroundColor: '#fafafa'}}>
            ...
            <View
              ...
              <Text style={{marginLeft: 20}}>Task Category</Text>
              {this.state.fetchJob && (
                // <Text style={{paddingRight: 20}}>
            ...
            <View
              ...
              <Text style={{marginLeft: 20}}>No. of Bids</Text>
              {this.state.fetchJob && (
                // <Text style={{paddingRight: 20}}>
            ...
            <View
              ...
              <Text style={{marginLeft: 20}}>Average Bid</Text>
              {this.state.fetchJob && (
                // <Text style={{paddingRight: 20}}>
            ...
            <View
              ...
              <Text style={{marginLeft: 20}}>Task Budget</Text>
              {this.state.fetchJob && (
