            ...
            {this.state.fetchMessageList ?
                <FlatList
                                ...
                                renderItem={({ item }) => (
                                    ...
                                    backgroundColor: '#fff', flexDirection: 'column', borderRadius: 4, overflow: 'hidden', flex: 1, flexDirection: 'column', marginTop: 3 , marginLeft:5 , marginRight:7 , marginBottom:3, elevation: 5,
                                    shadowOffset: { width: 0, height: 2 },
                                    shadowOpacity: 0.2,
                                    shadowColor: "#000",
                                    }}
