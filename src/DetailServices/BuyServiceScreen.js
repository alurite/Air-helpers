...
import { View, Text, StyleSheet, TouchableOpacity, Image, TextInput, Switch, AsyncStorage, Alert } from "react-native";
    ...
    axios
      ...
      .then(async response => {
        if (response.status === 200) {
          ...
          this.props.navigation.navigate("BuyServiceWebview", { url: response.data.url });
        ...
        <ScrollView>
          <View style={{
            ...
            <View style={{ height: 45, top: 15, flexDirection: 'row' }}>
              <Text style={{ color: '#fff', marginLeft: 10, width: '80%' }} >Total</Text>
              <Text style={{ color: '#fff', width: "20%" }} >{`${entities.decode(params.price)}`}</Text>
            </View>
            <View style={{ height: 45, top: 15, flexDirection: 'row' }}>
              <Text style={{ color: '#fff', marginLeft: 10, width: '80%' }} >Currency</Text>
              <Text style={{ color: '#fff', width: "20%" }} >USD</Text>
            </View>
            <View style={{ height: 45, top: 15, flexDirection: 'row' }}>
              <Text style={{ color: '#fff', marginLeft: 10, width: '80%' }} >Tax</Text>
              <Text style={{ color: '#fff', width: "20%" }} >0.00</Text>
            </View>
            <View style={{ borderBottomColor: "#dddddd", borderBottomWidth: 0.6 }} />
            <View style={{ height: 45, top: 15, flexDirection: 'row' }}>
              <Text style={{ color: '#fff', marginLeft: 10, width: '80%' }} >Total Payable</Text>
              <Text style={{ color: '#fff', width: "20%" }} >{`${entities.decode(params.price)}`}</Text>
            </View>
          </View>
          <Text
          ...
          <View style={{
            ...
            <TextInput style={{ height: 45, paddingLeft: 10, color: "#323232" }}
              placeholder="Name"
          ...
          <View style={{
            ...
            <View style={{ flexDirection: 'row', height: 45, marginLeft: 10 }}>
              <AntIcon name="creditcard" size={15} color={CONSTANT.primaryColor} style={{ top: 15 }} />
              <Text style={{ color: '#999999', top: 13, fontSize: 15, marginLeft: 10 }}>Payment Method</Text>
            </View>
            <View style={{ borderBottomColor: "#dddddd", borderBottomWidth: 0.6 }} />
            <View style={{ flexDirection: 'row', height: 45, marginLeft: 10 }}>
              <Text style={{ color: '#999999', top: 13, fontSize: 15, marginLeft: 10 }}>Available Payment Methods</Text>
            </View>
            <View style={{ borderBottomColor: "#dddddd", borderBottomWidth: 0.6 }} />
            <View style={{ height: 45, flexDirection: 'row' }}>
              <Text style={{ color: '#999999', top: 15, marginLeft: 10, width: '80%' }} >Credit Card(Stripe)</Text>
              <Switch style={{ width: '20%', textAlign: 'center', alignSelf: 'center', transform: [{ scaleX: .6 }, { scaleY: .6 }] }}></Switch>
            </View>
          </View>
          <TouchableOpacity
