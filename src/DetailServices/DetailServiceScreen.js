...
class DetailServiceScreen extends Component {
  ...
  fetchServiceData = async () => {
    ...
    const response = await fetch(
      CONSTANT.BaseUrl + "services/get_services?listing_type=single&service_id=" + params.service_id
    );
...
=
          ...
          <View style={{ flexDirection: "row", marginLeft: 20, marginBottom: 20 }}>
            <Text style={{ fontSize: 18, color: CONSTANT.primaryColor, fontWeight: '700' }}>
              {entities.decode(this.state.fetchSingleServiceAmount)}
            </Text>
            <Text style={{ fontSize: 10, marginLeft: 5, color: '#999999', alignSelf: 'flex-end' }}>{CONSTANT.DetailServicStarting}</Text>
          </View>
          <View style={{ flexDirection: "column", backgroundColor: "#fafafa" }}>
            ...
            >
              <Text style={{ marginLeft: 20 }}>{CONSTANT.DetailServiceDelivery}</Text>
            ...
            >
              <Text style={{ marginLeft: 20 }}>{CONSTANT.DetailServiceViews}</Text>
              <Text style={{ paddingRight: 20 }}>
            ...
            >
              <Text style={{ marginLeft: 20 }}>{CONSTANT.DetailServiceSales}</Text>
              <Text style={{ paddingRight: 20 }}>
            ...
            <View
              ...
              <Text style={{ marginLeft: 20 }}>{CONSTANT.DetailServiceResponse}</Text>
              <Text style={{ paddingRight: 20 }}>            
            ...
            >
              <Text style={{ marginLeft: 20 }}>{CONSTANT.DetailServiceFeedback}</Text>
              <Text style={{ paddingRight: 20 }}>
            ...
            >
              <Text style={{ marginLeft: 20 }}>{CONSTANT.DetailServiceServices}</Text>
              <Text style={{ paddingRight: 20 }}>
            ...
            >
              <Text style={{ marginLeft: 20 }}>{CONSTANT.DetailServiceClick}</Text>
              <Text style={{ paddingRight: 20 }}>
            ...
            <View style={{ width: '100%', marginTop: 20 }}>
              <Text style={{ textAlign: 'center', color: '#999999', fontSize: 12, marginLeft: '10%', marginRight: '10%' }}>
              ...
              <TouchableOpacity
                onPress={() =>
                  this.props.navigation.navigate(
                    "BuyServiceScreen",
                    { price: this.state.fetchSingleServiceAmount, id: this.state.fetchSingleServiceservice_id }
                  )
                }
                style={{
                  alignItems: "center",
            ...
            >
              <View style={{ flexDirection: "row", backgroundColor: "#fff" }}>
                ...
                >
                  ...
                  <Text style={{ marginRight: 50 }}>{this.state.fetchSingleServiceauther_title}</Text>
                </View>
              </View>
            </View>
          </View>
          ...
          <View style={{ marginLeft: 20, marginRight: 20 }}>
            <HTML html={this.state.fetchSingleServicecontent} imagesMaxWidth={Dimensions.get('window').width} />
          </View>
          <View
            style={{
              flexDirection: "row",
