    ...
    return (
      <View>
        {this.props.featuredJObColor != "" ? (
          <View cardElevation={2} cardMaxElevation={2} cornerRadius={5} style={styles.shadow}>
            {this.props.featuredJObColor != "" ? (
              <View
              ...
              />
                ...
                <View
                  style={this.FeaturedStyle('#4FFBF7')}
                />
              )}
            <Image
              style={{
            ...
            <View cardElevation={2} cardMaxElevation={2} cornerRadius={5} style={styles.shadow2}>
              {this.props.featuredJObColor != "" ? (
                <View
                  style={this.FeaturedStyle(this.props.featuredJObColor)}
                />
