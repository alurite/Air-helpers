      ...
      <View style={styles.container}>
        ...
        <ScrollView>
          ...
          >
            ...
            <View style={{ alignSelf: 'center', alignItems: 'center', alignContent: 'center', height: 45 }}>
              {
            ...
            <TextInput
              ...
              style={{
                ...
                padding: 5,
                height: 50,
                borderWidth: 0.6, borderRadius: 4, marginTop: 10, marginBottom: 10, marginLeft: 5, marginRight: 5, borderColor: '#dddddd'
              }}
              name="username"
