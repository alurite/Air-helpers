...
class PostService extends Component {
  ...
  joinDataForAddons = () => {
    this.arrayAddon.push({ title: this.state.textTitle_Holder, price: this.state.textPrice_Holder, description: this.state.textDecription_Holder });
    this.setState({ arrayHolder_Addon: [...this.arrayAddon] });
  }
  ...
  PostService = async () => {
    ...
    if(Title != "" &&
      ...
      CatKnown != ""&&
      LangKnown != ""&&
      AddonServiceKnown != "" && images.length != "" ){
  ...
  render() {
    ...
    const { showAlert, showSuccessAlert, isLoading, isUpdatingLoader, imagesAddFile, images } = this.state;
      ...
      <View style={styles.container}>
        ...
        <ScrollView>
          ...
          <View style={{ marginLeft: 20, marginRight: 20, marginBottom: 20 }}>
            <MultiSelect
              style={{ borderColor: "#323232", borderRadius: 4, borderWidth: 0.6 }}
              ref={component => {
          ...
          <View style={{
            ...
            <RadioGroup
              style={{ marginBottom: 10, flexDirection: "row", alignContent: 'center', alignItems: 'center', }}
              color={CONSTANT.primaryColor}
              ...
              {this.state.imagesAddFile != null ?
                <View style={{ marginLeft: 10, marginRight: 10 }}>
                  <SwipeableFlatList
                    ...
                    renderItem={({ item }) => (
                      <View style={{ borderWidth: 0, margin: 5, height: 45, flexDirection: "column", paddingTop: 12, backgroundColor: "#f7f7f7" }}>
                        <Text style={{ color: '#3d4461', fontSize: 15, paddingLeft: 5 }} onPress={this.GetItem.bind(this, item.title)} > {item.name} </Text>
                      </View>
                    )}
                    renderRight={({ item }) => (
                      <TouchableOpacity style={{ height: 45, margin: 5, width: 45, backgroundColor: '#fe736e', justifyContent: 'center', flexDirection: 'row', }}
          ...
          {this.state.arrayHolder_Addon != null ?
            <View style={{ marginLeft: 10, marginRight: 10 }}>
              <SwipeableFlatList
                ...
                renderItem={({ item }) => (
                  <View style={{ borderWidth: 0, margin: 5, height: 45, flexDirection: "column", paddingTop: 12, backgroundColor: "#f7f7f7" }}>
                    <Text style={{ color: '#3d4461', fontSize: 15, paddingLeft: 5 }}  > {item.title}  </Text>
                  </View>
                )}
                renderRight={({ item }) => (
                  <TouchableOpacity style={{ height: 45, margin: 5, width: 45, backgroundColor: '#fe736e', justifyContent: 'center', flexDirection: 'row', }}
          ...
          <TextInput
            ...
            style={{
              ...
              fontSize: 15,
              padding: 5,
              height: 150, borderWidth: 0.6, borderRadius: 4, borderColor: '#dddddd'
            }}
            name="username"
          ...
          <View style={{ flexDirection: 'row', marginLeft: 10, marginRight: 10, marginBottom: 10 }}>
            <TextInput onChangeText={data => this.setState({ textInput_Holder: data })} underlineColorAndroid="transparent" placeholder="Enter Url Here" style={{ paddingLeft: 10, height: 45, placeholderTextColor: '#f7f7f7', color: '#323232', borderTopLeftRadius: 4, borderBottomLeftRadius: 4, borderWidth: 0.6, borderColor: '#dddddd', marginBottom: 10, width: '80%' }} />
            <View style={{ backgroundColor: CONSTANT.primaryColor, height: 45, borderTopRightRadius: 4, borderBottomRightRadius: 4, width: '20%', justifyContent: 'center', flexDirection: 'row' }}>
          ...
          {this.state.arrayHolder != null ?
            <View style={{ marginLeft: 10, marginRight: 10 }}>
              <SwipeableFlatList
                ...
                renderItem={({ item }) => (
                  <View style={{ borderWidth: 0, margin: 5, height: 45, flexDirection: "column", paddingTop: 12, backgroundColor: "#f7f7f7" }}>
                    <Text style={{ color: '#3d4461', fontSize: 15, paddingLeft: 5 }}  > {item.videotitle} </Text>
                  </View>
                )}
          ...
          <Text style={{textAlign: "center",
              ...
              marginLeft: 20,
              marginRight: 20,
              marginBottom: 20}}>* Must select atleast one attachemnt otherwise data would not be submitted</Text>
          ...
          <View
            ...
            >
              <Text
                style={styles.selectFIleTextStyle}
              >
                Select File
              </Text>
            </TouchableOpacity>
